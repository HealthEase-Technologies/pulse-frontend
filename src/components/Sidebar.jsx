...
// Sprint 7: Thresholds for patients
if (userRole === "patient") {
  baseItems.push({
    name: "Thresholds",
...
// Sprint 9: AI Chatbot for patients
if (userRole === "patient") {
  baseItems.push({
    name: "AI Chat",
...
// Sprint 10: Health Reports for patients
if (userRole === "patient") {
  baseItems.push({
    name: "Reports",
...
// Sprint 8: Virtual Pet for patients
if (userRole === "patient") {
  baseItems.push({
    name: "My Pet",
    href: "/dashboard/patient/pet",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    // Sprint 10: Health Reports for providers
    if (userRole === "provider") {
      baseItems.push({
        name: "Reports",
